...
const TagBar: React.FC<TagBarProps> = ({ tags, selectedTag }) => {
  return (
    <>
      ...
      <div className="flex flex-row items-center gap-3 mb-5 text-lg text-light-200 font-roboto select-none h-9">
        <Link href="/blogs">
          <div className="px-3 py-1 rounded-md w-max cursor-pointer shadow-md bg-grey-500 text-light-200 hover:bg-grey-550 mr-2 flex flex-col justify-center items-center h-full">
